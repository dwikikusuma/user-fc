...
type UserServiceClient interface {
	GetUserByUserId(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoResponse, error)
}
...
func (c *userServiceClient) GetUserByUserId(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoResponse, error) {
...
type UserServiceServer interface {
	GetUserByUserId(context.Context, *GetUserInfoRequest) (*GetUserInfoResponse, error)
...
func (UnimplementedUserServiceServer) GetUserByUserId(context.Context, *GetUserInfoRequest) (*GetUserInfoResponse, error) {
...
func _UserService_GetUserByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserByUserId(ctx, req.(*GetUserInfoRequest))
	}
